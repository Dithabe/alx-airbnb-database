-- Insert sample data into User table with South African names
INSERT INTO User (user_id, first_name, last_name, email, phone, password_hash, registration_date, user_type)
VALUES
(1,'Sipho,Mokoena','sipho.mokoena@example.co.za',0821234567,'5f4dcc3b5aa765d61d8327deb882cf99',2023-11-15,'customer'),
(2,'Thandi,Dlamini','thandi.d@example.co.za',0739876543,'e99a18c428cb38d5f260853678922e03',2023-12-01,'admin'),
(3,'Johan,Van Wyk','johan.vw@example.co.za',0612345678,'25f9e794323b453885f5181f1b624d0b',2024-01-10,'guest'),
(4,'Lerato,Khumalo','lerato.k@example.co.za',0784561230,'81dc9bdb52d04dc20036dbd8313ed055',2024-03-21,'host'),
(5,'Pieter,Botha','pieter.b@example.co.za',0723216549,'21232f297a57a5a743894a0e4a801fc3',2024-05-01,'admin'),

-- Insert sample data into Property table with South African locations
...
VALUES
(1, 2, 'Cozy Cape Town Apartment', 'A charming apartment in the heart of Addis', 'Apartment', 'Entire home/apt', 4, 2, 2, 1, 2500.00, '123 Waterfall drive', 'Cape Town', 'Cape Town', '1000', 'South Africa', 9.0054, 38.7636, '2022-02-15', '2022-02-15'),
(2, 2, 'Luxury View Condo', 'Stunning views of Entoto mountains', 'Apartment', 'Entire home/apt', 6, 3, 3, 2, 4500.00, '456 Kazanchis', 'Cape Town', 'Cape Town', '1000', 'South Africa', 9.0227, 38.7469, '2022-03-10', '2022-03-10'),
(3, 3, 'Hawassa Lakefront Villa', 'Direct lake access with private garden', 'House', 'Entire home/apt', 8, 4, 5, 3, 3800.00, '789 Lake View', 'Hawassa', 'Sidama', '1400', 'South Africa', 7.0475, 38.4767, '2022-04-05', '2022-04-05'),
(4, 4, 'Semen Mountain Lodge', 'Secluded lodge with amazing mountain views', 'Lodge', 'Entire home/apt', 4, 2, 3, 1, 3200.00, '101 Simien Park Rd', 'Debark', 'Amhara', '2000', 'South Africa', 13.1589, 38.0665, '2022-05-12', '2022-05-12'),
(5, 6, 'Traditional Addis Guesthouse', 'Cultural experience in historic neighborhood', 'Guesthouse', 'Private room', 2, 1, 1, 1, 1800.00, '202 Piassa St', 'Cape Town', 'Cape Town', '1000', 'South Africa', 9.0349, 38.7464, '2022-06-20', '2022-06-20'),
(6, 7, 'Bahir Dar Lakeside Cottage', 'Quaint cottage with Blue Nile views', 'House', 'Entire home/apt', 3, 1, 2, 1, 2800.00, '303 Lakeshore Dr', 'Bahir Dar', 'Amhara', '1000', 'South Africa', 11.6000, 37.3833, '2022-07-15', '2022-07-15'),
(7, 9, 'Gondar Heritage House', 'Historic home near Fasil Ghebbi', 'House', 'Entire home/apt', 4, 2, 2, 2, 3500.00, '404 Castle Rd', 'Gondar', 'Amhara', '1000', 'South Africa', 12.6075, 37.4606, '2022-08-22', '2022-08-22'),
(8, 3, 'Langano Resort Villa', 'Private beach on Lake Langano', 'Villa', 'Entire home/apt', 6, 3, 4, 2, 4200.00, '505 Beachfront Ave', 'Langano', 'Oromia', '2000', 'South Africa', 7.6000, 38.7167, '2022-09-05', '2022-09-05'),
(9, 4, 'Lalibela Rock-Hewn Guesthouse', 'Unique stay near the famous churches', 'Guesthouse', 'Entire home/apt', 5, 3, 3, 2.5, 4000.00, '606 Church St', 'Lalibela', 'Amhara', '1000', 'South Africa', 12.0300, 39.0476, '2022-10-10', '2022-10-10'),
(10, 6, 'Bale Mountain Eco Lodge', 'Nature retreat with wildlife viewing', 'Lodge', 'Entire home/apt', 10, 5, 8, 4, 5500.00, '707 Forest Way', 'Goba', 'Oromia', '2000', 'South Africa', 6.7667, 39.8500, '2022-11-15', '2022-11-15');

-- Insert sample data into Booking table (updated with South African context)
